      ...
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        ...
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <h1 className="text-3xl font-bold pt-8 lg:pt-0">Raj Devkar</h1>
            ...
            <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
              ...
              <a href="https://buildnboost.com">buildnboost.com</a>
            </p>
            <p className="pt-8 text-sm">Turning ☕ into code.</p>
            ...
            <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
              <a
                className="link"
                href="https://facebook.com/rajdevkar99"
              ...
              <a
                className="link"
                href="https://github.com/tronix99"
